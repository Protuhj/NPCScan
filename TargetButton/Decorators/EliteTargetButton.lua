...
local function DecorateEliteTargetButton(button)
    ...
    local particle3 = button:CreateTexture(nil, "BACKGROUND", nil, 1)
    ...
    local particles2 = button:CreateTexture(nil, "BACKGROUND", nil, 2)
    ...
    local particles1 = button:CreateTexture(nil, "BACKGROUND", nil, 3)
    ...
    local starGlow = button:CreateTexture(nil, "BACKGROUND", nil, 4)
